"""
Utility functions for Boost release notes scraper
"""
...
def version_to_filename(version: str) -> str:
    ...
    Returns:
        Safe filename string (e.g., "1_36_0.md")
    """
    return version.replace(".", "_") + ".md"


def version_to_url(version: str, base_url_pattern: str = None) -> str:
    """
    Convert version string to Boost release URL.
    ...
    Returns:
        URL string (e.g., "https://www.boost.org/releases/1.36.0/")
    """
...
def parse_version_range(start: str, end: str) -> list:
    ...
    while tuple(current) <= end_tuple:
        ...
        if current[2] > 99:  # Arbitrary limit
            current[2] = 0
